...
<div align="left">
  <img src="./images/adjust_pipeline_args.png" width=80%>
</div>

### 1.日志开关(为了提升性能，默认设置为error)

<div align="left">
  <img src="./images/pipeline_log.png" width=80% />
</div>

### 2.JVM参数(推荐设置为容器可用内存的2/3左右)

<div align="left">
  <img src="./images/pipeline_jvm.png" width=80%>
</div>

### 3.并发处理线程数(10-200之间)（能够提升服务的并发数减少服务拒绝情况，可根据cpu核心和延迟综合考虑。）

<div align="left">
  <img src="./images/thread_count.png" width=80%>
</div>
